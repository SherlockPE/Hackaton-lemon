export default function Index() {
  return (
    <>
      {/* Encabezado */}
      <div
        className="min-h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center relative group font-serif"
        style={{
          backgroundImage:
            'url("https://tse4.mm.bing.net/th?id=OIG4.ToS1WldYwhifd5.5ACjo&pid=ImgGn")',
        }}
      >
      ...
      {/* Segunda imagen */}
      <div
        className="min-h-screen bg-cover bg-origin-content bg-no-repeat flex flex-col items-center justify-center relative group font-serif"
        style={{
      ...
      <div className="bg-white py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-4 text-lg text-gray-600 animate-fade-in">
            Nuestra app, basada en tecnología blockchain, permite a las personas
            conectar su identidad con su historial clínico, garantizando que
            esta información esté disponible de manera segura y accesible en
            cualquier país, en caso de emergencia o al viajar.
          </p>
        </div>
      </div>
      ...
      <footer className="bg-gray-800 text-white py-4 mt-0">
        <div className="max-w-6xl mx-auto flex flex-col items-center space-y-4">
          ...
          <div>
            <img
              src="https://tse4.mm.bing.net/th?id=OIG4.Mw7oCBD0Q0ma3djyRxqq&pid=ImgGn" // Reemplaza con la URL de tu logo
              alt="Logo"
